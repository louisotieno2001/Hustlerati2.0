...
router.post('/', checkAuth, async (req, res) => {
    try {
        ...
        const response = await query('/items/individual_bookings', {
            method: 'POST',
        ...
        if (!response.ok) {
            ...
            console.error('Error creating individual booking:', errorData);
        ...
        res.json({
            ...
            message: 'Individual booking created successfully'
        });
